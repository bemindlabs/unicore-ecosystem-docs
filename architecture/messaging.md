...
|-----------|-------|-------------|------|
| `unicores-unicore-kafka-1` | `confluentinc/cp-kafka:7.5.0` | `unicore-kafka:9092` | `9092` |
| `unicores-unicore-zookeeper-1` | `confluentinc/cp-zookeeper:7.5.0` | `unicore-zookeeper:2181` | `2181` (internal only) |
